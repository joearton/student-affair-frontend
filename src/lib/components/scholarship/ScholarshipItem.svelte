  ...
  <div class="border-0 d-flex justify-content-between align-items-center">
    <h5 class="mb-0">
      <a
        ...
        class:text-primary={scholarship.status === "closed" ||
          scholarship.eligible.status === false}
      >
    ...
    <div>
      {#if sch_referer == "account"}
        ...
        >
          <i
            class={scholarship.eligible.status ? "fa fa-check" : "fa fa-remove"}
          ></i>
    ...
    <div class="row small text-muted">
      <div class="col-md-6">
        <div class="mb-1 d-flex">
          <strong class="me-2"
            ><i class="fas fa-map-marker-alt"></i> Source</strong
          >
        ...
        <div class="mb-1 d-flex">
          ...
          <span
            >{scholarship.target_names.map((t: any) => t[0]).join(", ")}</span
          >
        </div>
        <div class="mb-1 d-flex">
      ...
      <div class="col-md-6">
        <div class="mb-1 d-flex">
          <strong class="me-2"
            ><i class="fas fa-calendar-alt"></i> Start Date</strong
          >
          <span>{scholarship.sch_start_date}</span>
        </div>
        <div class="mb-1 d-flex">
          <strong class="me-2"
            ><i class="fas fa-calendar-check"></i> End Date</strong
          >
          <span>{scholarship.sch_end_date}</span>
        </div>
        <div class="mb-1 d-flex">
          <strong class="me-2"
            ><i class="fas fa-graduation-cap"></i> Level</strong
          >
